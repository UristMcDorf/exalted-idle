...
export const DB_Skill = new Set([
    { id: "sleeping", ability: Ability.Integrity, maxLevel: 10, baseXpPerLevel: 500, xpScaling: 1.8, perks: new Map() },
    { id: "farming", ability: Ability.Physique, maxLevel: 10, baseXpPerLevel: 100, xpScaling: 1.8, perks: new Map() },
    { id: "toughness", ability: Ability.Physique, maxLevel: 10, baseXpPerLevel: 100, xpScaling: 1.8, perks: new Map() },
    { id: "timekeeping", ability: Ability.Sagacity, maxLevel: 10, baseXpPerLevel: 7200, xpScaling: 1.8, perks: new Map([
